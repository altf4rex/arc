...
const Logo = () => {
  return (
    <Link href='/' className="logo flex items-center mr-[70px]">
      <svg xmlns="http://www.w3.org/2000/svg" width="41" height="65" viewBox="0 0 41 65" fill="none" className="max-lg:hidden">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="98" height="65" viewBox="0 0 98 65" fill="none" className="max-lg:hidden">
